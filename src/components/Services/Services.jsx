...
const Services = () => {
  const data = [
    {
      icon: <img src={frontend} alt="code" className=" lg:w-[50px] w-[30px]" />,
    ...
    {
      icon: <img src={backend} alt="Api" className=" lg:w-[50px] w-[30px]" />,
      name: "Backend Development",
      description: "Building RESTful APIs with Express.js and MongoDB for storing and retrieving data.",
    },
    {
      icon: <img src={frontend} alt="responsive" className=" lg:w-[50px] w-[30px]" />,
      name: "UI/UX Design",
      ...
      <div className="flex flex-col gap-10 mt-20">
        {data.map((item) => (
          <div className="w-full border-slate-400 border rounded-3xl p-10 flex flex-col gap-10">
            <p className="lg:text-3xl text-2xl text-green-400 font-bold">
            {item.name}
            </p>
            <div>
            {item.icon}
